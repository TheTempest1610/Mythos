...
using Content.Client.UserInterface.Systems.CloseWindows;
...
public sealed class GameTopMenuBarUIController : UIController
{
    ...
    [Dependency] private readonly CloseWindowsUIController _closeWindows = default!;
